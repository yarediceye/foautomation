...
REQUIRES
issue.issueType.name.includes("IT")  || issue.issueType.name.includes("MOS")  || issue.issueType.name.includes("GS Passes") || issue.issueType.name.includes("Product Quality") || issue.issueType.name.includes("Platform")|| issue.issueType.name.includes("Incident - Space Segment")
 */
